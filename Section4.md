...
<div>Sem quebra de Linha: System.out.print("Bom dia!")</div>
<div>Com quebra de Linha: System.out.println("Bom dia!")</div>

Para limitar o número de casas decimais quando utilizar uma variável com número flutuante se utiliza este metódo:
<div>x = 10.35784</div>
<div>System.out.printf("%.2f%n", x) <--nesse caso utiliza-se o 2f para ser o limitante, irá mostrar somente duas casas decimais, o %n é a quebra de linha, já que para limitar a casa decimal se utiliza o printf (nesse caso ele irá arredondar), para mostrar com 4 casas basta alterar o 2 para 4.</div
